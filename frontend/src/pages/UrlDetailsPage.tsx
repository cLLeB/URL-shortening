          ...
          <div className="card-body">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatNumber(analytics.url.totalClicks)}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatNumber(analytics.summary.totalClicksInRange)}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatNumber(analytics.summary.uniqueCountries)}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatNumber(analytics.summary.uniqueDevices)}</p>
              </div>
            </div>
          </div>
        </div>
